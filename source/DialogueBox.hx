...
class DialogueBox extends FlxSpriteGroup
{
	...
	public function new(talkingRight:Bool = true, ?dialogueList:Array<String>)
	{
		...
		{
			case 'not-enough-money', 'its-fun-enough':
				hasDialog = true;
				box.frames = Paths.getSparrowAtlas('speech_bubble_talking', 'shared');
				box.animation.addByPrefix('normalOpen', 'Speech Bubble Normal Open', 20, false);
				box.animation.addByPrefix('normal', 'speech bubble normal', 0, false);
		...
		portraitLeft.frames = Paths.getSparrowAtlas('portraits/galExpressions', 'shared');
		/* Expressions */
		portraitLeft.animation.addByPrefix('normal', 'normla', 24, true);
		portraitLeft.animation.addByPrefix('bored', 'bored', 24, true);
		portraitLeft.animation.addByPrefix('happy', 'thumbsup', 24, true);
		/* ----------- */
		portraitLeft.updateHitbox();
		portraitLeft.scrollFactor.set();
		portraitLeft.flipX = false;
		portraitLeft.scale.x = 1.5;
		portraitLeft.scale.y = 1.5;
		...
		portraitRight.scale.x = 1.5;
		portraitRight.scale.y = 1.5;
