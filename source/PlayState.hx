	...
	override public function create()
	{
		...
		switch (songLowercase)
		{
			...
			case 'not-enough-money':
				dialogue = CoolUtil.coolTextFile(Paths.txt('not-enough-money/not-enough-moneyDialogue'));
			case 'its-fun-enough':
				dialogue = CoolUtil.coolTextFile(Paths.txt('its-fun-enough/its-fun-enoughDialogue'));
		}
		...
		switch(SONG.stage)
		{
			...
			case 'studio':
			{
						...
						var bg:FlxSprite = new FlxSprite(0, 0).loadGraphic(Paths.image('hammergal/Studio','shared'));
						bg.antialiasing = true;
						bg.scale.y = 1.8;
						bg.scale.x = 1.8;
